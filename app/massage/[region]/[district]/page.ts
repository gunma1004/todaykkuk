...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const titleTemplates = [
    ...
    `${locationTitle} 전신 힐링 마사지 프로그램 및 가격 안내 · 투데이쿡`,
    `${locationTitle} 1:1 맞춤형 바디케어 & 웰니스 테라피 - 투데이쿡`,
    `${locationTitle} 편안한 힐링 마사지 제휴업체 정보 | 투데이쿡`,
    `${locationTitle} 쾌적한 스웨디시 & 아로마 웰니스 안내 - 투데이쿡`,
    `${locationTitle} 웰니스 바디 테라피 및 정찰제 코스 가이드 · 투데이쿡`,
    `${locationTitle} 전문 스웨디시 마사지 힐링 스팟 | 투데이쿡`,
    `${locationTitle} 감성 테라피 및 아로마 마사지 할인 안내 · 투데이쿡`,
    `${locationTitle} 지친 일상을 깨우는 시원한 마사지 케어 - 투데이쿡`,
    `${locationTitle} 프라이빗 타이 마사지 및 릴랙싱 테라피 · 투데이쿡`,
  ...
  const descTemplates = [
    ...
    `${locationTitle} 인근에서 차별화된 출장마사지 서비스를 찾고 계신다면 투데이쿡의 엄선된 제휴 코스와 합리적인 요금표를 확인해보세요.`,
    `${locationTitle} 맞춤형 힐링 테라피 안내입니다. 집이나 숙소로 부르는 편리한 출장마사지부터 쾌적한 전문 매장까지 한눈에 비교할 수 있습니다.`,
    `${locationTitle} 프라이빗한 휴식을 선사하는 출장마사지 및 타이·아로마 케어 프로그램. 숙련된 전문가의 손길로 피로를 날려보세요.`,
    `${locationTitle} 정성 어린 손길의 출장마사지 및 전신 바디케어 정보. 투명한 정찰제와 쾌적한 웰니스 코스를 지금 바로 만나보세요.`,
    `${locationTitle} 종합 힐링 가이드. 해당 구역 내에서 믿을 수 있는 출장마사지 서비스와 고급 스웨디시 마사지 업소를 편리하게 찾아보세요.`,
    `${locationTitle} 프리미엄 테라피 안내. 일상에 활력을 불어넣어 주는 전문 출장마사지 및 다양한 바디케어 프로그램을 안내해 드립니다.`,
    ...
    <main className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">
          {regionName} {districtName} 마사지 및 출장마사지 제휴 안내
        </h1>
        <p className="text-gray-600 mb-8">
          원하시는 동을 선택하여 상세한 제휴업체 정보와 코스별 요금을 확인해 보세요.
        </p>
        
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <p className="text-sm text-gray-500">
            현재 경로: /massage/{region}/{district}
          </p>
        </div>
      </div>
    </main>
